      ...
      <div className="sixth-container">
        <div className="sixth-left-container">
          ...
          <div className="buttons">
            ...
            >
              ...
              />
              <p>
                <strong>1. Portable Design: </strong>
                Compact, lightweight, and easy to carry for on-the-go
                convenience.
              </p>
              <p>
                <strong>2. Brilliant Display: </strong>
                8.3-inch Liquid Retina screen with vivid colors and sharp
                clarity.
              </p>
              <p>
                <strong>3. Powerful Performance: </strong>
                Fast A-series chip for smooth multitasking and gaming.
              </p>
              <p>
                <strong>4. Advanced Connectivity: </strong>
                5G, Wi-Fi 6, and USB-C for fast internet and versatile accessory
                support.
              </p>
            </Modal>
        ...
        <div className="sixth-right-container">
          ...
          <button className="estimate-btn">
            <a
              href="https://www.apple.com/in/shop/trade-in"
